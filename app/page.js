...
import { FaChild, FaRobot, FaGamepad, FaCode, FaStar, FaLaptopCode, FaRegSmile, FaRegLightbulb, FaUsers } from 'react-icons/fa';
...
const FloatingShapes = () => {
  const shapes = [
    ...
    { color: 'bg-[#00B894]', size: 'w-20 h-20', position: 'bottom-1/4 left-1/3' },
    { color: 'bg-[#FD79A8]', size: 'w-12 h-12', position: 'bottom-1/3 right-1/5' },
  ];
...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      quote: "My daughter went from playing games to creating them in just 3 months!",
      rating: 5
    },
    {
      name: "Raj's Dad",
      role: "Parent of 11-year-old",
      quote: "The teachers make complex concepts so accessible for kids. Highly recommend!",
      rating: 5
    },
    {
      name: "Emma's Parents",
      role: "Parents of 6-year-old",
      quote: "Our shy daughter has gained so much confidence through coding. She loves her classes!",
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F8F9FA] to-[#E3F2FD] overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6">
            <a href="#courses" className="font-medium hover:text-[#6C5CE7] transition-colors">Courses</a>
            <a href="#how-it-works" className="font-medium hover:text-[#6C5CE7] transition-colors">How It Works</a>
            <a href="#testimonials" className="font-medium hover:text-[#6C5CE7] transition-colors">Success Stories</a>
            <a href="#pricing" className="font-medium hover:text-[#6C5CE7] transition-colors">Pricing</a>
          </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Where kids transform from tech users to tech creators through play-based learning!
            </p>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our curriculum grows with your child, from first clicks to advanced projects
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {ageGroups.map((group) => (
              <motion.button
                ...
                whileHover={{ y: -5 }}
                whileTap={{ scale: 0.95 }}
                className={`${group.color} p-6 rounded-xl shadow-md text-white text-center transition-all ${activeAge === group.range ? 'ring-4 ring-white scale-105 z-10' : 'opacity-90 hover:opacity-100'}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                {courses[activeAge].map((course, index) => (
                  ...
                  >
                    <div className="flex items-start gap-6 mb-6">
                      <div className={`p-4 rounded-xl ${course.color} text-white`}>
                        {course.icon}
                      </div>
                      <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-gray-700 mb-2">Skills Developed:</h4>
                        <ul className="space-y-2">
                          {course.skills.map((skill, i) => (
                            <li key={i} className="flex items-start">
                              <BsFillPatchCheckFill className={`mt-1 mr-2 flex-shrink-0 ${course.color}`} />
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-700 mb-2">Sample Projects:</h4>
                        <ul className="space-y-2">
      ...
      {/* ===== TESTIMONIALS ===== */}
      <section id="testimonials" className="py-16 px-4 bg-gradient-to-r from-[#E3F2FD] to-[#F3E5F5]">
        <div className="container mx-auto">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
